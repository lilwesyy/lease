                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="engine" name="engine" value="{{ $vehicle->engine }}">
                            </div>
                            <div class="mb-3">
                                <label for="traction" class="form-label">Traction</label>
                                <input type="text" class="form-control" id="traction" name="traction" value="{{ $vehicle->traction }}">
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="type" name="type">
                                    ...
                                    <option value="supercar" {{ $vehicle->type == 'supercar' ? 'selected' : '' }}>Supercar</option>
                                </select>
                            </div>
                        </div>
                    </div>
